...
export default async function Page({ params: { slug } }) {
  ...
  return (
    ...
    <div className="md:w-4/5 bg-slate-900 border-4 border-slate-800 rounded-lg">
      <div className="flex h-full flex-col md:flex-row overflow-y-scroll">
        ...
        <div className="md:w-9/12 bg-slate-900 overflow-y-scroll pb-10" style={height}>
          ...
          <div className="w-fit pt-1 ms-6 hidden md-block">
            ...
            <div className="w-fit pt-1 ms-1">
              <div className="mt-1 bg-slate-900 pt-2 px-4 rounded-t-md">
                ...
                <span className="text-md ms-5 md:ms-10 text-slate-500">
                  <Link className="shine" href="/post">X</Link>
                </span>
              </div>
            </div>
          </div>
          <article className="post mt-10 ms-5 md:ms-10">
